...
function initShortQuestion() {
 qstHead[0]="   Beispiel Zu Mittag klingelte Susannes Telefon. Richtig Falsch   ";
 qstHead[1]="  Die Bio-Gasanlage .. A gehört Eckhard Meier. B gibt es seit einem Dreivierteljahr. C produziert Strom und Wärme.";
 qstHead[2]="7 In diesem Text geht es um ... ";
 qstHead[3]="8 Die Wissenschaftler wollten zeigen, dass ...";
 qstHead[4]="9 Damit die Idee auch in anderen Dörfern funktioniert, ...";
 qstHead[5]="    10    In diesem Text geht es darum, dass ... ";
 qstHead[6]="11Für die Rundfahrt ...";
 qstHead[7]="12    Der Geschäftsführer von Murten Tourismus       will, dass ...";
 qstHead[8]="      Beispiel  Mario möchte in Wien einen Sommersprachkurs besuchen.  Anzeige: i ";
 qstHead[9]="Teil 3";
 qstHead[10]="   Beispiel  Niko  Ja  nein";
 qstHead[11]="   Teil 5 ";
 qstHead[12]="27   Schüler ... ";
 qstHead[13]="28   Für die Klassenräume des BZW gilt: ";
 qstHead[14]="29   Um die verschließbaren Fächer benutzen zu können, muss man ... ";
 qstHead[15]="30   Das Trinken von Alkohol ...";
}
