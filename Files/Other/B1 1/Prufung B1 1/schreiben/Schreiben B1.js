...
var qstHead;
var groups;
var quizTitle="Schreiben B1 deutsch pour tous et tous pour deutsch";
var printCpRg=1;
var filename = 'Schreiben B1';
...
function initShortQuestion() {
 qstHead[0]="Schreiben Sie eine E-Mail (circa 80 Wörter). Schreiben Sie etwas zu allen drei Punkten.  Achten Sie auf den Textaufbau (Anrede, Einleitung, Reihenfolge der Inhaltspunkte, Schluss).  Beispiel:    ";
 qstHead[1]="Schreiben Sie nun Ihre Meinung zum Thema (circa 80 Wörter).    Beispiel:     ";
 qstHead[2]="Schreiben Sie an Frau Müller.  Entschuldigen Sie sich höflichund berichten Sie, warum Sie nicht kommen können.Schreiben Sie eine E-Mail (circa 40 Wörter). Vergessen Sie nicht die Anrede und den Gruß am Schluss.    Beispiel:   ";
}
...
function Constructor() {
  valid = new init_array(0,0,0);
  nScore = new init_array(0,0,0);
  maxScore = new init_array(0,0,0);
  qstHead = new init_array("","","");
  qstRem = new init_array("","","");
  initShortQuestion();
  initQuestionRemark();
  groups = new init_array(0,0,0);
  pesi = new init_array(0,0,0);
  allAnsReport = new init_array(3);
  ordineDomande = new init_array(0,1,2);
  typeOfQuest = new init_array(3,3,3);
  isQuestCustom = new init_array(0,0,0);
  omitPoint = new init_array(0,0,0);
}
