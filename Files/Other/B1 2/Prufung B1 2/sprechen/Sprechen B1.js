...
function initShortQuestion() {
 qstHead[0]=" Sprechen Sie über die Punkte unten, machen Sie Vorschläge und reagieren Sie auf die Vorschläge Ihres Gesprächspartners/Ihrer Gesprächspartnerin.Planen und entscheiden Sie gemeinsam, was Sie tun möchten.   Reise nach Köln planen - Wann? - Wie hinkommen? (Flug, Bahn, ...) - Wo wohnen? (Hotel, bei Familien, ...) - Was mitnehmen?";
 qstHead[1]=" Sie sollen Ihren Zuhörern ein aktuelles Thema präsentieren. Dazu finden Sie hier fünf Folien. Folgen Sie den Anweisungen links und schreiben Sie Ihre Notizen und Ideen rechts daneben.                   ";
