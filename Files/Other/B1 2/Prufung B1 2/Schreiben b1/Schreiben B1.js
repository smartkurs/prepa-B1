...
function initShortQuestion() {
 qstHead[0]="Schreiben Sie eine E-Mail (circa 80 Wörter). Schreiben Sie eine E-Mail (circa 80 Wörter).Schreiben Sie etwas zu allen drei Punkten. Achten Sie auf den Textaufbau (Anrede, Einleitung, Reihenfolge der Inhaltspunkte, Schluss).  Beispiel:    ";
 qstHead[1]="Schreiben Sie nun Ihre Meinung zum Thema (circa 80 Wörter).    Beispiel:     ";
 qstHead[2]="Schreiben Sie eine E-Mail (circa 40 Wörter).Vergessen Sie nicht die Anrede und den Gruß am Schluss   Beispiel:   ";
}
